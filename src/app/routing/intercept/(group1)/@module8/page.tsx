...
export default async function Home(props) {
    return (
     <div　style={{border:"1px solid black"}}>
         ...
         <br />
         <Link href={"/routing/intercept/module8_1"}>/routing/parallel2/(group1)/@module8/(..)module8_1 にリンク</Link>
         →リロード時は/routing/parallel2/(group2)module8_1 としてロードされる
         <br />
         <Link href={"/routing/intercept/module8_2"}>/routing/parallel2/(group1)/@module8/(.)module8_2 にリンク</Link>
